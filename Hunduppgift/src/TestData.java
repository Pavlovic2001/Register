...
public final class TestData {
     ...
     */
    public static final String REMOVE_OWNER_OF_DOG_METHOD_NAME = "removeOwner";
     ...
     */
    public static final String SCANNER_ADAPTER_CLASS_NAME = "InputHandler";

    /**
     * Detta är namnet på den metod i din inläsningsklass som läser in text från
     * användaren.
     */
    public static final String READ_TEXT_METHOD_NAME = "readLine";
     ...
     * listan.
     */
    public static final String DOG_LIST_CLASS_ADD_DOG_METHOD_NAME = "addDogToList";

    /**
     * Detta är namnet på metoden i hundlistklassen som tar bort en hund ur listan.
     */
    public static final String DOG_LIST_CLASS_REMOVE_DOG_METHOD_NAME = "removeDogFromList";

    /**
     * Detta är namnet på metoden i hundlistklassen som kontrollerar om en given
     * hund finns i listan eller inte.
     */
    public static final String DOG_LIST_CLASS_DOG_EXISTS_METHOD_NAME = "isDogInList";
     ...
     */
    public static final String ADD_DOG_TO_OWNER_METHOD_NAME = "assignDogToOwner";
     ...
     */
    public static final String REMOVE_DOG_FROM_OWNER_METHOD_NAME = "removeDog";
     ...
     * U7.7.1.2.
     */
    public static final String SWAP_DOGS_USING_CLASS_LIBRARY_METHOD_NAME = "swapDogsWithCollection";
     ...
     */
    public static final String LIST_DOGS_METHOD_NAME = "showDogList";
